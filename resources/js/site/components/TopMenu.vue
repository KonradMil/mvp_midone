<template>
    <Popover class="relative bg-white">
        <div class="max-w-10xl mx-auto px-2 sm:px-2">
            <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-4">
                <div class="flex justify-start lg:w-0 lg:flex-1">
                    <a href="#">
                        <span class="sr-only">Workflow</span>
                        <img class="h-12 w-auto sm:h-12" src="/s3/twopointo/images/svg_notagline.svg" alt="" />
                    </a>
                </div>
                ...
                <PopoverGroup as="nav" class="hidden md:flex space-x-10">
                    <Popover class="relative" v-slot="{ open }">
                        <PopoverButton :class="[open ? 'text-gray-500' : 'text-gray-900', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']">
                            <span class="nunito font-bold">Społeczność</span>
                    ...
                    <a href="#" class="text-base text-gray-900 hover:text-gray-500 nunito font-bold">
                        Produkty
                    </a>
                    <a href="#" class="text-base text-gray-900 hover:text-gray-500 nunito font-bold">
                        Rozwiązania
                    ...
                    <Popover class="relative" v-slot="{ open }">
                        <PopoverButton :class="[open ? 'text-gray-500' : 'text-gray-900', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']">
                            <span class="nunito font-bold">Baza wiedzy</span>
                            <!--                            <ChevronDownIcon :class="[open ? 'text-gray-600' : 'text-gray-400', 'ml-2 h-5 w-5 group-hover:text-gray-500']" aria-hidden="true" />-->
                        </PopoverButton>
                    ...
                    <a href="#" class="text-base font-bold text-gray-900 hover:text-gray-500 nunito">
                        Wsparcie i usługi
                    </a>
                    <a href="#" class="text-base font-bold text-gray-900 hover:text-gray-500 nunito">
                        O firmie
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    <a href="#" class="top-buttons btn-white-bg ml-8 whitespace-nowrap inline-flex items-center justify-center px-6 border text-base text-white">
                        Zaloguj
                    </a>
                    <a href="#" class="top-buttons btn-color-bg ml-8 whitespace-nowrap inline-flex items-center justify-center px-6 border text-base text-white">
                        Zarejestruj
                    </a>
                </div>
            </div>
