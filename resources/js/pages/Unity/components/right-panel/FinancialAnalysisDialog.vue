...
export default {
    ...
    setup(props, context) {
        ...
        const npv = ref(0);
        const financialsAnalysis = reactive({
        ...
        emitter.on('financialsAnalysisSave', e => {
            axios.post('/api/solution/financial-analysis/save', {solution_id: props.solution.id, financialsAnalysis: financialsAnalysis, capitalCost: capitalCost.value, capex: capex.value, timeframe: timeframe.value})
                .then(response => {
