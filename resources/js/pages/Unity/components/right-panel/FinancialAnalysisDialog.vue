                    ...
                    <table class="table">
                        ...
                        <tr class="hover:bg-gray-200">
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.days" class="form-control" placeholder="260,00" :placeholder="$t('challengesNew.days')" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.days')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.shifts" class="form-control" placeholder="30,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.shifts')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.shift_time" class="form-control" placeholder="8,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.shift_time')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.weekend_shift" class="form-control" placeholder="0" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.weekend_shift')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.breakfast" class="form-control" placeholder="30,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.breakfast')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.stop_time" class="form-control" placeholder="20,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.stop_time')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.operator_performance" class="form-control" placeholder="90,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.operator_performance')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.defective" class="form-control" placeholder="5,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.defective')}}
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.number_of_operators" class="form-control" placeholder="2,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.number_of_operators')}}
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.operator_cost" class="form-control" placeholder="4500,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.operator_cost')}}
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.absence" class="form-control" placeholder="12,00" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.absence')}}
                            ...
                            <td class="border">
                                ...
                                <input type="number" v-model="financial.cycle_time" class="form-control" placeholder="0" :aria-label="$t('challengesNew.numberSupported')" disabled/>
                            </td>
                            <td class="border">
                                <label for="input-wizard-9" class="form-label">
                                    {{$t('challengesNew.cycle_time')}}
