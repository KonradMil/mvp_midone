...
4
        ...
        onBeforeMount(() => {
            // if (props.unityLoader) {
                ...
                script.setAttribute('src', '/s3/unity/AssemBrot24_05_gzip.loader.js')
        ...
        const instantiate = () => {
            ...
            createUnityInstance(document.querySelector('#' + containerId.value), {
                dataUrl: "/s3/unity/AssemBrot24_05_gzip.data.gz",
                frameworkUrl: "/s3/unity/AssemBrot24_05_gzip.framework.js.gz",
                codeUrl: "/s3/unity/AssemBrot24_05_gzip.wasm.gz",
