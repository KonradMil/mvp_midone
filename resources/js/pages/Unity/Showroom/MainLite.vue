            ...
            switch (type) {
                ...
                case 'UnitySave':
                    if (!saving.value) {
                        ...
                        axios.post('/api/playground/freesaves/save', {
                            save: e.saveGame,
                            id: id.value,
                            name: freeSave.value.name,
                            en_name: freeSave.value.en_name,
                            description: freeSave.value.description,
                            en_description: freeSave.value.en_description
                        })
                            .then(response => {
                                saving.value = false;
