            ...
            <div class="col-span-12 box intro-y shadow-md">
                <div class="p-10">
                    <div class="w-full flex flex-row">
                        <h2 class="text-lg font-medium mr-auto">Konkurs zakończony - proszę oczekiwać na wyniki</h2>
...
<!--                            <div style="overflow-y: scroll; max-height: 50vh">-->
<!--                                <p>-->
<!--                                    W istniejących procesach na określonych obszarach od 1 do 5  znajdź minimum 5  błędów, które Twoim zdaniem sprawiają iż proces ten jest nieefektywny bądź niezgodny z zasadami bezpieczeństwa. Uzasadnij swoje wybory korzystając z opcji komentarzy.-->
<!--                                </p>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
