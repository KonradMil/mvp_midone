        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y col-span-12 lg:col-span-6">
                <div class="intro-y box">
                    ...
                    >
                        <h2 class="font-medium text-base mr-auto">Polityka prywatności - jak chronimy Twoje dane?</h2>
                    </div>
                        ...
                        <div class="preview">
                            <div class="leading-relaxed">
                                <p class="mb-5">
                                    ...
                                    2.1 Administratorem danych osobowych jest DBR77 sp. z o.o. z siedzibą w Toruniu.
                                    2.2 Wyznaczyliśmy Inspektora Ochrony Danych, tj. osobę, która może udzielić szczegółowych informacji na temat przetwarzania danych. Skontaktuj się z nami: contact@db77.pl lub DBR77 sp. z o.o., ul. Żółkiewskiego 31, 87-100 Toruń.
                                    3. Dane osobowe
