        ...
        <div class="p-5">
            <div class="flex flex-col-reverse xl:flex-row flex-col">
                <div class="flex-1 mt-6 xl:mt-0">
                        ...
                        <div class="col-span-12 xxl:col-span-6">
                            ...
                            <div class="mt-3">
                                ...
                                <input
                                    ...
                                    v-model="company.nip"
                                />
                                <button class="btn btn-primary w-1/4 mt-2" @click.prevent="searchNip">
                                    {{ $t('profiles.searchFor') }} NIP
                                </button>
                            </div>
                        </div>
                        <div class="col-span-12 xxl:col-span-6">
                            <div class="mt-3">
                                ...
                                />
                                <button class="btn btn-primary w-1/3 mt-2" @click.prevent="searchRegon">
                                    {{ $t('profiles.searchFor') }} REGON
                                </button>
                            </div>
                            <div class="mt-3">
                                ...
                                <input
                                    ...
                                    v-model="company.krs"
                                />
                                <button class="btn btn-primary w-1/4 mt-2" @click.prevent="searchKRS">
                                    {{ $t('profiles.searchFor') }} KRS
                                </button>
                            </div>
                        </div>
                        <div class="col-span-12 xxl:col-span-6">
                    ...
                    <button v-if="!isUndefined" class="btn btn-primary w-20 mt-3" type="submit" @click.prevent="save">
                        {{ $t('global.save') }}
                    </button>
                    <button v-if="isUndefined" class="btn btn-primary w-20 mt-3" type="submit" @click.prevent="create">
                        {{ $t('global.save') }}
                    </button>
                </div>
            </div>
