...
<!--                        </div>-->
                        <div v-for="(solution, index) in challenge.solutions" :key="index" v-if="((challenge.stage < 2) && (user.id === challenge.solution.author_id))" class="intro-y col-span-6 md:col-span-4 xl:col-span-6 box" :class="(solution.selected)? 'solution-selected': ''">
