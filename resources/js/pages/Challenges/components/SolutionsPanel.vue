                    ...
                    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div v-for="(solution, index) in challenge.solutions" :key="index" v-if="challenge.stage < 2" class="intro-y col-span-6 md:col-span-4 xl:col-span-6 box" :class="(solution.selected)? 'solution-selected': ''">
                                <span v-if="user.type == 'integrator'">
                                    <SingleSolutionPost v-if="solution.author_id === user.id" :user="user" :challenge="challenge" :solution="solution" :canAccept="(user.id === challenge.author_id) && challenge.status == 1" :canEdit="user.id === solution.author_id"></SingleSolutionPost>
                                </span>
