...
<!--                        </div>-->
                        <div v-for="(solution, index) in solutions.list" :key="index" v-if="challenge.stage < 2" class="intro-y col-span-6 md:col-span-4 xl:col-span-6 box" :class="(solution.selected) ? 'solution-selected' : ''">
