            ...
            <div class="intro-y box col-span-12 xxl:col-span-12">
                ...
                <div class="px-5 py-5">
                    ...
                    <div class="intro-y grid grid-cols-12 gap-6 mt-5" >
                        <div v-if="((challenge.stage >= 2) || (user.id === 'investor') || ((user.type==='integrator') && (user.id = solution.author_id)))" v-for="(solution, index) in challenge.selected" class="intro-y col-span-6 md:col-span-4 xl:col-span-6 box solution-selected">
