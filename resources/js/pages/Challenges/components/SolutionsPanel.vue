...
<!--                        </div>-->
                        <div v-for="(solution, index) in solutions" :key="index" v-if="challenge.stage < 2" class="intro-y col-span-6 md:col-span-4 xl:col-span-6 box" :class="(solution.selected!=null) ? 'solution-selected' : ''">
