...
<!--    </div>-->
    ...
    <div v-if="guard.value === 1" class="intro-y col-span-12 lg:col-span-8 xxl:col-span-9" >
        <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
        ...
        <div v-if="guard.value != 1" class="text-theme-1 dark:text-theme-10 font-medium pl-2 py-3" style="font-size: 16px;">
