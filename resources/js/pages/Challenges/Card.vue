<template>
    <div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <OfferAdd v-if="activeTab == 'addingoffer'" :solution_save="solution.save_json" :solution_id="selected_solution_id" :challenge_id="challenge.id" :edit_offer_id="edit_offer_id"></OfferAdd>
