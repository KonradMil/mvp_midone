                    ...
                    <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                        ...
                        <a class="flex items-center mt-5" href="" v-if="challenge != undefined"
                           ...
                           :class="(activeTab == 'rozwiazania')? ' text-theme-1 dark:text-theme-10 font-medium' : 'mt-5'">
                            ...
                            <div v-if="challenge.selected != undefined && challenge.selected.length != 0">{{$t('challengesMain.solutions')}}</div><div v-if="challenge.selected == undefined || challenge.selected.length == 0">Rozwiązania</div>
                        </a>
