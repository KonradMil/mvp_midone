...
<!--&lt;!&ndash;                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">&ndash;&gt;-->
<!--&lt;!&ndash;                                <Avatar :src="'/s3/avatars/' + invite.inviter.avatar" :username="invite.inviter.name + ' ' + invite.inviter.lastname" :size="40" color="#FFF" background-color="#930f68"/>&ndash;&gt;-->
<!--&lt;!&ndash;                            </div>&ndash;&gt;-->
