<template>
    <div class="intro-y box shadow-2xl" style="width: 1000px;">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
            ...
            <div class="flex items-center justify-center text-theme-6" style="margin-right: 400px;" v-if="project.project_accept_vision === 2"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i>{{$t('challengesMain.rejected')}}</div>
