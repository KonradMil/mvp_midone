                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"><span class="es-button-border" style="border-style:dashed;border-color:#FFFFFF;background:#5e50ac;border-width:0px;display:inline-block;border-radius:0px;width:auto"><a href="{{env('APP_URL')}}/teams/user/accept_invite/{{ $invite->accept_token }}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:22px;color:#FFFFFF;border-style:solid;border-color:#5e50ac;border-width:10px 20px;display:inline-block;background:#5e50ac;border-radius:0px;font-weight:bold;font-style:normal;line-height:26px;width:auto;text-align:center">AKCEPTUJ ZAPROSZENIE</a></span></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
