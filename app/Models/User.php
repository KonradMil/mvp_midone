...
class User extends Authenticatable implements ReacterableInterface, Commentator
{
    ...
    public function teams () {
        return $this->belongsToMany(Team::class, 'team_user')->withPivot('publishChallenge', 'editChallenge', 'acceptChallengeOffer', 'publishSolution', 'addSolutionOffer','acceptChallengeSolution', 'addChallengeSolution')->using(TeamUser::class)->withTimestamps();
    }
