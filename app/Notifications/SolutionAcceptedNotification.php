...
class SolutionAcceptedNotification extends Notification
{
    use Queueable;
    public $solution;
    public $challenge;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('DBR77: rozwiązanie zaakceptowane')
    ...
    public function toBroadcast($notifiable)
    {
        return new BroadcastMessage([
            'message' => 'Rozwiązanie zostało zaakceptowane do wyzwania: ' . $this->challenge->name .'.',
