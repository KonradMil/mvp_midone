...
//        dd(Auth::user()->ownedTeams);
        ...
        if($who == 'teams'){
            $query = Auth::user()->teams()->with('users', 'users.companies', 'users.pivot.publishChallenge')
                ->withPivot('publishChallenge', 'publishChallenge', 'acceptChallengeOffer', 'publishSolution', 'addSolutionOffer')->get();
