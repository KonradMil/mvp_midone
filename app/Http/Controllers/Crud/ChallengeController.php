    ...
    public function getCardData(Request $request)
    {
        if (isset($request->id)) {
            $challenge = Challenge::with(
                ...
                'solutions.teams.users', 'solutions.teams.users.companies' , 'solutions.offers', 'solutions.estimate'
            )->find($request->id);
...
//        }
        ...
        $challenge->selected = $challenge->solutions()->where('selected', '=', 1)->with('estimate')->get();
