...
class OfferController extends Controller
{
    public function filterChallengeOffers(Request $request)
    {
        ...
        if($option === 'Cena-max'){
            ...
            $offers = $challenge->offers()->join('solutions as so', 'so.id', '=', 'offers.solution_id')->join('operational_analyses as oa', 'oa.solution_id', '=', 'so.id')->with('solution', 'solution.operational_analyses')->orderBy('oa.oee_after', 'DESC')->get();
        }
